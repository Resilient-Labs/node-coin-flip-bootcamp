// This code is a collaboration of HOUSE CASS: zikre h., ken c., sam d., miggie g., shane g.
...
fetch('/calculateWinnerHeads')
  ...
  document.getElementById('showResult').innerHTML = winStatement;

  }else{
    // display.innerHTML = "sad"
    document.getElementById('displayCoin').src = "back.png"
    document.getElementById('showResult').innerHTML = loseStatement;
